...
// _level0.ruta = _global.estandar;
 var variable: String = "E"+_level0.LMS;
   if ( variable == "Eaicc") {
	...
	//FORZANDO A QUE AJURO AGARRE ESTA RUTA
	//archivo = _level0.OA+".swf"+"?aicc_url="+_level0.AICC_URL+"&aicc_sid="+_level0.AICC_SID+"&miXML="+archivoXML;						
   //_level0.ruta = variable;
	unloadMovieNum(1);
	loadMovieNum(archivo, 1);
}
